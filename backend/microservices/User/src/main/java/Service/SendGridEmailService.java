...
public class SendGridEmailService {
    ...
    @Value("${matchfreelance.public-app-url:http://localhost:4200}")
            ...
            String htmlContent = """
                    ...
                    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                            ...
                            <div style="background-color: #f0fdf4; border: 3px solid #16a34a; padding: 28px; margin: 24px 0; text-align: center; border-radius: 12px;">
                                <p style="margin:0 0 8px 0; font-size: 14px; color: #166534; font-weight: bold;">VOTRE CODE (6 chiffres)</p>
                                <p style="color: #15803d; font-size: 36px; font-weight: 800; letter-spacing: 8px; margin: 0; font-family: ui-monospace, Consolas, monospace;">%s</p>
                            </div>
    ...
    public void sendPasswordResetEmailWithCode(String toEmail, String firstName, String verificationCode) {
        try {
            ...
            String base = publicAppUrl.endsWith("/") ? publicAppUrl.substring(0, publicAppUrl.length() - 1) : publicAppUrl;
            String resetPage = base + "/reset-password?email=" + URLEncoder.encode(toEmail, StandardCharsets.UTF_8);
            ...
            String htmlContent = 
                ...
                "            1. Ouvrez <a href='" + resetPage + "'>la page de réinitialisation</a> (Angular).<br>" +
                "            2. Saisissez le code à 6 chiffres et votre nouveau mot de passe.<br>" +
                "            <br>" +
                "            <strong>⏰ Ce code expire dans 24 h.</strong>" +
                "        </div>" +
                "        <p><strong>Sécurité :</strong> si vous n'avez pas demandé cette réinitialisation, ignorez cet e-mail.</p>" +
                "    </div>" +
                "    <div class='footer'>" +
