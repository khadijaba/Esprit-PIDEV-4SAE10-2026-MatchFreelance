...
public class Project {
    ...
    /**
     * ID du proprietaire du projet (utilisateur). Pas d'entite User dans ce microservice :
     * le User est dans un autre microservice (camarade). On stocke uniquement l'ID.
     */
