...
public class CandidatureRankingService {
    ...
    public List<RankedCandidatureDTO> getRankedCandidatures(Long projectId, Double minScore, Integer limit) {
     ...
     */
    @Transactional(readOnly = true)
    public BudgetStatsDTO getBudgetStats(Long projectId) {
        List<Candidature> list = candidatureRepository.findByProjectId(projectId);
