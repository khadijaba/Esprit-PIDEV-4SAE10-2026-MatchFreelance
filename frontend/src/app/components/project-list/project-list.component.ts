...
import { SmartFreelancerDiscoveryComponent } from '../smart-freelancer-discovery/smart-freelancer-discovery.component';

@Component({
  selector: 'app-project-list',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, SmartFreelancerDiscoveryComponent],
...
export class ProjectListComponent implements OnInit {
  ...
  /** Lien détail : Project Owner reste dans /project-owner/projects/:id ; Admin → /admin/projects/:id */
  getProjectRoute(id: number): string {
    return this.isProjectOwnerRoute() ? `/project-owner/projects/${id}` : `/admin/projects/${id}`;
  }
