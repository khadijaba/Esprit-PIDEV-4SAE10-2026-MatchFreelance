...
export const routes: Routes = [
  // Frontoffice (public) – login/register inside layout for header+footer with logo
  {
    ...
    children: [
      ...
      {
        path: 'project-owner/projects/:id/candidatures',
        loadComponent: () =>
          import('./components/project-owner-candidatures/project-owner-candidatures.component').then(
            (m) => m.ProjectOwnerCandidaturesComponent
          ),
        canActivate: [projectOwnerGuard],
      },
      {
        path: 'project-owner/projects/:id/supervision',
        loadComponent: () =>
      ...
      {
        path: 'project-owner/projects/:id/supervision/meeting/:phaseId/:meetingId',
        loadComponent: () =>
          import('./components/phase-meeting-room/phase-meeting-room.component').then(
            (m) => m.PhaseMeetingRoomComponent
          ),
        canActivate: [projectOwnerGuard],
      },
      {
        path: 'project-owner/projects/:id',
        loadComponent: () =>
  ...
  // Espace Freelancer (protected, role FREELANCER)
  {
    path: 'freelancer',
    component: FrontLayoutComponent,
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./components/skill-evolution-dashboard/skill-evolution-dashboard.component').then((m) => m.SkillEvolutionDashboardComponent),
      },
      {
        path: 'notifications',
        loadComponent: () =>
      ...
      },
      {
        path: 'supervision',
        loadComponent: () =>
          import('./components/freelancer-project-supervision/freelancer-project-supervision.component').then(
            (m) => m.FreelancerProjectSupervisionComponent
          ),
      },
      {
        path: 'supervision/meeting/:projectId/:phaseId/:meetingId',
        loadComponent: () =>
          import('./components/phase-meeting-room/phase-meeting-room.component').then(
            (m) => m.PhaseMeetingRoomComponent
          ),
