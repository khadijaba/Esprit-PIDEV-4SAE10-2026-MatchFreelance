...
export class InterviewScheduleComponent implements OnInit {
  ...
  loadInterviews() {
    ...
    this.interviewService.getByCandidatureId(this.candidatureId).subscribe({
      next: (data) => {
  ...
  scheduleInterview() {
    ...
    this.interviewService.schedule(this.candidatureId, {
  ...
  updateStatus(interview: Interview, status: InterviewStatus) {
    this.interviewService.update(this.candidatureId, interview.id, {
  ...
  deleteInterview(interview: Interview) {
    ...
    this.interviewService.delete(this.candidatureId, interview.id).subscribe({
      next: () => {
