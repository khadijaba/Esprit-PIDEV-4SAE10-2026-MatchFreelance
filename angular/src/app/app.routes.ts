...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./components/auth/oauth2-redirect/oauth2-redirect.component').then(m => m.Oauth2RedirectComponent),
  },
  {
    path: 'profile',
    loadComponent: () => import('./components/profile/profile.component').then(m => m.ProfileComponent),
    // canActivate: [authGuard] // Temporarily disabled for testing with mock data
  },
  // Frontoffice (public)
  {
    path: '',
    ...
    children: [
      ...
      },
      {
        path: 'threads',
        loadComponent: () =>
          import('./components/threads/threads.component').then((m) => m.ThreadsComponent),
      },
      {
        path: 'groups',
        loadComponent: () =>
          import('./components/discussion-groups/discussion-groups-list/discussion-groups-list.component').then((m) => m.DiscussionGroupsListComponent),
      },
      {
        path: 'groups/create',
        loadComponent: () =>
          import('./components/discussion-groups/group-create/group-create.component').then((m) => m.GroupCreateComponent),
      },
      {
        path: 'groups/:id',
        loadComponent: () =>
          import('./components/discussion-groups/group-detail/group-detail.component').then((m) => m.GroupDetailComponent),
      },
    ],
  },
